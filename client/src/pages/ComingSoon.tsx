    ...
    <div className="flex min-h-[60vh] items-center justify-center animate-fade-in-up">
      <Card className="w-full max-w-md text-center">
        <CardContent className="flex flex-col items-center gap-4 p-10">
          <div className="flex size-14 items-center justify-center rounded-[16px] border border-pure/[0.06] bg-graphite">
            <Icon className="size-6 text-cyan" />
          </div>
          <div className="space-y-1.5">
            <h1 className="font-display text-xl font-normal text-cloud">{title}</h1>
